...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~OqQxQBKT#Uti_O9C1zkN6Kuce9D3VvSpHWIEv4zGGEQByoVOXHgc", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "35670509", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "Kelly-tec", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "kelly-tec", // Added // Input Yours custom...
...
BOT_NAME: process.env.BOT_NAME || "wolf", // Input Yours custom...(Maintain font for Flow)
